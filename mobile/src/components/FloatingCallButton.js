...
const FloatingCallButton = ({
  ...
  const floatingBottom = Math.max(bottomInset, 12) + 36;
  ...
  return (
    <>
      ...
      {showCallControls && !isExpanded ? (
        <TouchableOpacity
          style={[styles.expandButton, { bottom: floatingBottom + controlSize + 90, backgroundColor: colors.surface, borderColor: colors.border }]}
      ...
      {statusLabel && !showCallControls ? (
        <View style={[styles.statusIndicator, { bottom: statusBottom + 60, backgroundColor: colors.surface, borderColor: colors.border }]}>
